...
class RMM_NN(nn.Module):
    def __init__(self, grid_size=[25, 25],  channels=2, verbose=False):
        ...
        self.contract1 = nn.Sequential(
            ...
            torch.nn.BatchNorm2d(Cout1,eps=1e-07).float(),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=Cout1,
                out_channels=Cout1,
        ...
        self.contract2 = nn.Sequential(
            ...
            torch.nn.BatchNorm2d(Cout2,eps=1e-07).float(),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=Cout2,
                out_channels=Cout2,
        ...
        self.contract3 = nn.Sequential(
            ...
            torch.nn.BatchNorm2d(Cout3,eps=1e-07).float(),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=Cout3,
                out_channels=Cout3,
        ...
        self.expand2 = nn.Sequential(
            ...
            torch.nn.BatchNorm2d(2*Cout1,eps=1e-07).float(),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=2*Cout1,
                out_channels=Cout1,
